...
#ifndef SOAP_TYPE_ns__get_DEFINED
#define SOAP_TYPE_ns__get_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__get(struct soap*, struct ns__get *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__get(struct soap*, const struct ns__get *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__get(struct soap*, const char*, int, const struct ns__get *, const char*);
SOAP_FMAC3 struct ns__get * SOAP_FMAC4 soap_in_ns__get(struct soap*, const char*, struct ns__get *, const char*);

SOAP_FMAC3 struct ns__get * SOAP_FMAC4 soap_new_ns__get(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__get(struct soap*, const struct ns__get *, const char*, const char*);

#ifndef soap_write_ns__get
#define soap_write_ns__get(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__get(soap, data), 0) || soap_put_ns__get(soap, data, "ns:get", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__get * SOAP_FMAC4 soap_get_ns__get(struct soap*, struct ns__get *, const char*, const char*);

#ifndef soap_read_ns__get
#define soap_read_ns__get(soap, data) ( ((data) ? (soap_default_ns__get(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__get(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__getResponse_DEFINED
#define SOAP_TYPE_ns__getResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__getResponse(struct soap*, struct ns__getResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__getResponse(struct soap*, const struct ns__getResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__getResponse(struct soap*, const char*, int, const struct ns__getResponse *, const char*);
SOAP_FMAC3 struct ns__getResponse * SOAP_FMAC4 soap_in_ns__getResponse(struct soap*, const char*, struct ns__getResponse *, const char*);

SOAP_FMAC3 struct ns__getResponse * SOAP_FMAC4 soap_new_ns__getResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__getResponse(struct soap*, const struct ns__getResponse *, const char*, const char*);

#ifndef soap_write_ns__getResponse
#define soap_write_ns__getResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__getResponse(soap, data), 0) || soap_put_ns__getResponse(soap, data, "ns:getResponse", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__getResponse * SOAP_FMAC4 soap_get_ns__getResponse(struct soap*, struct ns__getResponse *, const char*, const char*);

#ifndef soap_read_ns__getResponse
#define soap_read_ns__getResponse(soap, data) ( ((data) ? (soap_default_ns__getResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__getResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__hex_and_pass_DEFINED
#define SOAP_TYPE_ns__hex_and_pass_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__hex_and_pass(struct soap*, struct ns__hex_and_pass *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__hex_and_pass(struct soap*, const struct ns__hex_and_pass *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__hex_and_pass(struct soap*, const char*, int, const struct ns__hex_and_pass *, const char*);
SOAP_FMAC3 struct ns__hex_and_pass * SOAP_FMAC4 soap_in_ns__hex_and_pass(struct soap*, const char*, struct ns__hex_and_pass *, const char*);

SOAP_FMAC3 struct ns__hex_and_pass * SOAP_FMAC4 soap_new_ns__hex_and_pass(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hex_and_pass(struct soap*, const struct ns__hex_and_pass *, const char*, const char*);

#ifndef soap_write_ns__hex_and_pass
#define soap_write_ns__hex_and_pass(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__hex_and_pass(soap, data), 0) || soap_put_ns__hex_and_pass(soap, data, "ns:hex-and-pass", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__hex_and_pass * SOAP_FMAC4 soap_get_ns__hex_and_pass(struct soap*, struct ns__hex_and_pass *, const char*, const char*);

#ifndef soap_read_ns__hex_and_pass
#define soap_read_ns__hex_and_pass(soap, data) ( ((data) ? (soap_default_ns__hex_and_pass(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__hex_and_pass(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__hex_and_passResponse_DEFINED
#define SOAP_TYPE_ns__hex_and_passResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__hex_and_passResponse(struct soap*, struct ns__hex_and_passResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__hex_and_passResponse(struct soap*, const struct ns__hex_and_passResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__hex_and_passResponse(struct soap*, const char*, int, const struct ns__hex_and_passResponse *, const char*);
SOAP_FMAC3 struct ns__hex_and_passResponse * SOAP_FMAC4 soap_in_ns__hex_and_passResponse(struct soap*, const char*, struct ns__hex_and_passResponse *, const char*);

SOAP_FMAC3 struct ns__hex_and_passResponse * SOAP_FMAC4 soap_new_ns__hex_and_passResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hex_and_passResponse(struct soap*, const struct ns__hex_and_passResponse *, const char*, const char*);

#ifndef soap_write_ns__hex_and_passResponse
#define soap_write_ns__hex_and_passResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__hex_and_passResponse(soap, data), 0) || soap_put_ns__hex_and_passResponse(soap, data, "ns:hex-and-passResponse", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__hex_and_passResponse * SOAP_FMAC4 soap_get_ns__hex_and_passResponse(struct soap*, struct ns__hex_and_passResponse *, const char*, const char*);

#ifndef soap_read_ns__hex_and_passResponse
#define soap_read_ns__hex_and_passResponse(soap, data) ( ((data) ? (soap_default_ns__hex_and_passResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__hex_and_passResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__hex_DEFINED
#define SOAP_TYPE_ns__hex_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__hex(struct soap*, struct ns__hex *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__hex(struct soap*, const struct ns__hex *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__hex(struct soap*, const char*, int, const struct ns__hex *, const char*);
SOAP_FMAC3 struct ns__hex * SOAP_FMAC4 soap_in_ns__hex(struct soap*, const char*, struct ns__hex *, const char*);

SOAP_FMAC3 struct ns__hex * SOAP_FMAC4 soap_new_ns__hex(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hex(struct soap*, const struct ns__hex *, const char*, const char*);

#ifndef soap_write_ns__hex
#define soap_write_ns__hex(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__hex(soap, data), 0) || soap_put_ns__hex(soap, data, "ns:hex", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__hex * SOAP_FMAC4 soap_get_ns__hex(struct soap*, struct ns__hex *, const char*, const char*);

#ifndef soap_read_ns__hex
#define soap_read_ns__hex(soap, data) ( ((data) ? (soap_default_ns__hex(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__hex(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_ns__hexResponse_DEFINED
#define SOAP_TYPE_ns__hexResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__hexResponse(struct soap*, struct ns__hexResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__hexResponse(struct soap*, const struct ns__hexResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__hexResponse(struct soap*, const char*, int, const struct ns__hexResponse *, const char*);
SOAP_FMAC3 struct ns__hexResponse * SOAP_FMAC4 soap_in_ns__hexResponse(struct soap*, const char*, struct ns__hexResponse *, const char*);

SOAP_FMAC3 struct ns__hexResponse * SOAP_FMAC4 soap_new_ns__hexResponse(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hexResponse(struct soap*, const struct ns__hexResponse *, const char*, const char*);

#ifndef soap_write_ns__hexResponse
#define soap_write_ns__hexResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__hexResponse(soap, data), 0) || soap_put_ns__hexResponse(soap, data, "ns:hexResponse", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__hexResponse * SOAP_FMAC4 soap_get_ns__hexResponse(struct soap*, struct ns__hexResponse *, const char*, const char*);

#ifndef soap_read_ns__hexResponse
#define soap_read_ns__hexResponse(soap, data) ( ((data) ? (soap_default_ns__hexResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__hexResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
